...
public class Weapon : MonoBehaviour
{
    ...
    IEnumerator Shoot()
    {
        ...
        if(!weaponData.automatic)
        {
            ...
            float xRot = UnityEngine.Random.Range(-weaponData.spreadFactor, weaponData.spreadFactor);
            float yRot = UnityEngine.Random.Range(-weaponData.spreadFactor, weaponData.spreadFactor);
